  ...
  <div class="resources-view">
    ...
    <div class="resources-header">
      <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-6">网盘资源库</h1>
    ...
    <div class="container mx-auto px-4 pb-8">
      ...
      <div v-else-if="resources.length === 0" class="text-center py-12">
        ...
        <p class="text-gray-600 mb-6">暂时没有找到符合条件的资源</p>
      ...
      <div v-if="isAuthenticated" class="mt-8 text-center">
        <el-button type="primary" size="large" @click="navigateToCreate" class="px-8">
          <el-icon class="mr-2">
            <Plus />
          </el-icon>
          发布新资源
...
import { Search, Loading, FolderOpened, Plus } from '@element-plus/icons-vue'
